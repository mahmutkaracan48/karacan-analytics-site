...
export function PreviewPage({ scan }: { scan: ScanPreview }) {
  ...
  const visibleFindings = findings.slice(0, TEASER_FINDINGS);

  const locked = lockedFindings(scan);

  const lockedIssueCount = Math.max(

    critical - visibleFindings.length,
      ...
      <div className="wrap">
          ...
          {lockedIssueCount > 0 ? (
            ...
            <div className="findings-gate" aria-label="Additional issues require activation">
              ...
              <p className="findings-unlock">
                ...
                <a href={activation} onClick={() => trackEvent(slug, "cta_click_499")}>
        ...
        <div className="card card--footer">
          ...
          <p className="subcta">
            ...
            <a href="mailto:contact@karacan-analytics.com">Reply to your email or contact us</a>
